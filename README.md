...
<p> <strong>BoxJump</strong> is a a very simple platformer with just one level. Use <code>WASD</code> or <code>arrow keys</code> to move and <code>space</code> to jump. </p>
